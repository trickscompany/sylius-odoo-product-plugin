...
namespace Fabit\SyliusOdooProductPlugin\Exceptions;

class AttributeNotFoundException extends \Exception
{
    public function __construct(string $attributeCode, int $code = 0, ?\Throwable $previous = null)
    {
        $message = \sprintf('Attribute %s does not exist in Sylius', $attributeCode);
